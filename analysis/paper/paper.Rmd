...
author:
  - Nuno Bicho (ICArEHB, University of Algarve)
  - João Cascalheira (ICArEHB, University of Algarve)
date: '`r Sys.Date()`'
output: 
...
```{r figure3, fig.cap="Correlation plots between Dimension 1 and 2 (left) and Dimension 3 and 4 (right)"}
