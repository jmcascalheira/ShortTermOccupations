...
There are, however, other variables that have been listed as possible indicative of duration of occupation. These include site area, number of features, and spatial segregation of activities [e.g. @binford_willow_1980; @dillehay_research_2011; @nishiaki_patterning_2015]. 
...
The results of our analysis indicate that, unlike what specified by Clark and Barton [-@clark_lithics_2017], patterns revealed by the inverse relationship between retouch frequency and lithic volumetric density are not always consistent with specific durations of site occupation. Assemblages classified under the traditional concepts of expedient and curated technologies may not necessarily be associated with the time spent at a specific site by human groups.
